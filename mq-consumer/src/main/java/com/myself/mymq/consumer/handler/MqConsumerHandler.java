package com.myself.mymq.consumer.handler;
...
import com.myself.mymq.common.dto.resp.MqConsumerResultResp;
...
public class MqConsumerHandler extends SimpleChannelInboundHandler {
    ...
    private MqCommonResp dispatch(RpcMessageDto rpcMessageDto,ChannelHandlerContext ctx){
        ...
        log.debug("channelId:{} 接收到method：{} 内容：{} ",channelId,methodType,json);
        //消息发送
